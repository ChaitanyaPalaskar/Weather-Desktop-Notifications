...
def tell_weather() :
	...
	api_key = "66739b29ce17a0991ca22794d4d69114"
	...
	if weather_data.json()['cod'] != '404':
		...
		current_pressure = round(weather_data.json()['main']["pressure"])

		# store the value corresponding to the "humidity" key of y
		current_humidity = round(weather_data.json()['main']["humidity"])
		...
		weather_description = str(weather_data.json()['weather'][0]['description'])
...
if __name__ == "__main__" :
	...
	city_field.grid(row = 1, column = 1, ipadx ="90") 
	temp_field.grid(row = 3, column = 1, ipadx ="90") 
	atm_field.grid(row = 4, column = 1, ipadx ="90") 
	humid_field.grid(row = 5, column = 1, ipadx ="90") 
	desc_field.grid(row = 6, column = 1, ipadx ="90")

	# Create a Submit Button and attached 
	# to tell_weather function 
	button1 = Button(root, text = "Submit", bg = "skyblue", 
					fg = "black", command = tell_weather)

	# Create a Clear Button and attached 
	# to clear_all function 
	button2 = Button(root, text = "Clear", bg = "skyblue", 
